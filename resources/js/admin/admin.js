...
window.toggleImageUpload = function() {
    ...
    const singleUpload = document.getElementById("single-image-upload");
    const multipleUpload = document.getElementById("multiple-image-upload");
    if (singleUpload && multipleUpload) {
        singleUpload.style.display = selectedOption === "single" ? "block" : "none";
        multipleUpload.style.display = selectedOption === "single" ? "none" : "block";
    }
}
...
// end: Chart
    ...
    // Initialize Popper for dropdowns
