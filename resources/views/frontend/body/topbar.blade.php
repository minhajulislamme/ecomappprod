<div class="sticky top-0 z-50 bg-white shadow-sm">
    ...
    <div class="max-w-7xl mx-auto hidden lg:flex items-center py-2 px-4">
        ...
        <div class="flex-none space-x-1">
            @auth
                <a href="{{ route('user.dashboard') }}" class="text-1xl text-orange-400 p-2 rounded-sm hover:bg-orange-50">
                    <i class="ri-user-line"></i>
                </a>
            @else
                
                    <a href="{{ route('login') }}" class="text-1xl text-orange-400 p-2 rounded-sm hover:bg-orange-50">
                        <i class="ri-user-line"></i>
                    </a>
