    ...
    <main class="max-w-7xl mx-auto px-4 py-4 pb-20 lg:pb-8">
            ...
            <div>
                <ol class="flex items-center space-x-2 text-sm">
                    ...
                    @if ($subcategory->category)
                        <li><a href="{{ route('product.category', ['id' => $subcategory->category->id, 'slug' => $subcategory->category->category_slug]) }}"
                                class="text-gray-500 hover:text-orange-500">{{ $subcategory->category->category_name }}</a>
                        </li>
                        <li><span class="text-gray-400">/</span></li>
                    @endif
                    <li><span class="text-orange-500">{{ $subcategory->subcategory_name }}</span></li>
                </ol>
            </div>
            <div class="lg:hidden ">
        ...
        <div class="flex flex-col lg:flex-row gap-6">
                        ...
                        <div class="border-b pb-4">
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center cursor-pointer group">
                                    ...
                                    <span class="ml-2 text-gray-700 group-hover:text-orange-500">Electronics (245)</span>
                                </label>
                                <!-- Add more categories -->
                            </div>
                        </div>
            ...
            <div class="flex-1">
                ...
                <div class="mb-6">
                    <h1 class="text-2xl font-bold text-gray-800">{{ $subcategory->subcategory_name }}</h1>
                    <p class="text-gray-500">{{ count($products) }} products found</p>
                </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
                    ...
                    @empty
                        <div class="col-span-full py-10 text-center">
                            <h2 class="text-xl font-semibold text-gray-600">No products found in this subcategory</h2>
                            <p class="mt-2 text-gray-500">Try checking out other subcategories or check back later</p>
                        </div>
                    @endforelse
                </div>
