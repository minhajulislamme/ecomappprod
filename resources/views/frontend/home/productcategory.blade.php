<div class="max-w-7xl mx-auto px-4 py-2">
    ...
    <div class="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-10 gap-2">
        ...
        @foreach ($Categories as $Category)
            <a href="#"
                class="flex flex-col items-center group p-2 bg-white rounded-lg hover:shadow-md transition-all duration-300">
                ...
                <span
                    class="font-medium text-[10px] sm:text-xs text-gray-800 group-hover:text-orange-500 text-center truncate w-full px-1">
