    ...
    <div class="p-6">
        <div class="p-6 bg-white items-center shadow-md shadow-black/5 rounded-md border border-gray-100 mb-6">
            ...
            <div class="flex justify-between mb-4 items-start">
                <div>
                    <div class="text-lg font-semibold">Shipping Data Table </div>
                    <div class="text-sm font-medium text-gray-400">All Shipping Charges List </div>
                </div>
                <div class="dropdown">
                    <button type="button"
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{ route('shipping.charge.add') }}"
                                    ...
                                    <span class="text-gray-600 group-hover:text-orange-500 font-medium">Add Shipping Charge</span>
                                </a>
                            </li>
                    ...
                    <tbody id="tableBody">
                        @foreach ($charges as $key => $item)
                            <tr class="data-row">
                                ...
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <span class="text-[13px] font-medium text-gray-400">{{ $item->charge }}</span>
                                </td>
                                ...
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <div class="ml-2 dropdown">
                                        ...
                                        <ul
                                            ...
                                            <li>
                                                <a href="{{ route('shipping.charge.edit', $item->id) }}"
                                            ...
                                            <li>
                                                <a href="#"
                                                    onclick="confirmDelete('{{ route('shipping.charge.delete', $item->id) }}')"
                                                    class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-orange-500 hover:bg-gray-50">
