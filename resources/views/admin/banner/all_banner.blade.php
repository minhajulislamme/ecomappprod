    ...
    <div class="p-6">
        <div class="p-6 bg-white items-center shadow-md shadow-black/5 rounded-md border border-gray-100 mb-6">
            ...
            <div class="flex justify-between mb-4 items-start">
                <div>
                    <div class="text-lg font-semibold">Banner Data Table </div>
                    <div class="text-sm font-medium text-gray-400">All Banner list </div>
                </div>
                <div class="dropdown">
                    <button type="button"
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{route('banner.add')}}"
                                    ...
                                    <span class="text-gray-600 group-hover:text-orange-500 font-medium">Add Banner</span>
                                </a>
                            </li>
