    ...
    <div class="p-6">
        <div class="p-6 bg-white items-center shadow-md shadow-black/5 rounded-md border border-gray-100 mb-6">
            ...
            <div class="flex justify-between mb-4 items-start">
                <div>
                    <div class="text-lg font-semibold">Coupon Data Table </div>
                    <div class="text-sm font-medium text-gray-400">All Coupon list </div>
                </div>
                <div class="dropdown">
                    <button type="button"
                            ...
                            <tr class="data-row">
                                ...
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <div class="flex items-center">
                                        <span class="text-[13px] font-medium text-gray-400">{{ $item->coupon_name }}</span>
                                    </div>
                                </td>
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <span class="text-[13px] font-medium text-gray-400">{{ $item->coupon_discount }}%</span>
                                </td>
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <span
                                        class="text-[13px] font-medium text-gray-400">{{ Carbon\Carbon::parse($item->coupon_validity)->format('D, d F Y') }}</span>
                                </td>
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                ...
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <div class="ml-2 dropdown">
                                        ...
                                        <ul
                                            ...
                                            <li>
                                                <a href="#"
                                                    onclick="confirmDelete('{{ route('coupon.delete', $item->id) }}')"
                                                    class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-orange-500 hover:bg-gray-50">
