    ...
    <div class="p-6">
        <div class="p-6 bg-white items-center shadow-md shadow-black/5 rounded-md border border-gray-100 mb-6">
            ...
            <div class="flex justify-between mb-4 items-start">
                <div>
                    <div class="text-lg font-semibold">Flash Sales Data Table </div>
                    <div class="text-sm font-medium text-gray-400">All Flash Sales list </div>
                </div>
                <div class="dropdown">
                    <button type="button"
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{ route('flash.sale.timer.edit') }}"
                                    ...
                                    <span class="text-gray-600 group-hover:text-orange-500 font-medium">Edit Time</span>
                                </a>
                            </li>
                        ...
                        @foreach ($timer as $key => $item)
                            <tr class="data-row">
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <span class="text-[13px] font-medium text-gray-400">{{ (int) $key + 1 }}</span>
                                </td>
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <div class="flex items-center">
                                        <span class="text-[13px] font-medium text-gray-400">{{ $item->start_time }}</span>
                                    </div>
                                </td>
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <span class="text-[13px] font-medium text-gray-400">{{ $item->end_time }}</span>
                                </td>
                                ...
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <div class="ml-2 dropdown">
                                        ...
                                        <ul
                                            ...
                                            <li>
                                                <a href="{{ route('flash.sale.timer.edit', $item->id) }}"
            ...
            <div class="flex justify-center my-5">
                <div id="noResults" class="text-gray-500" style="display: none;">
                    No results found
                </div>
