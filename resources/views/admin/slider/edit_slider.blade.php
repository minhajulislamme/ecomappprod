    ...
    <div class="p-6">
        <div class="p-6 bg-white items-center shadow-md shadow-black/5 rounded-md border border-gray-100 mb-6">
            <div class="flex justify-between mb-6">
                <div>
                    <div class="text-lg font-semibold">Edit Slider</div>
                    <div class="text-sm font-medium text-gray-400">Update existing slider</div>
                </div>
                <div class="dropdown">
                    <button type="button"
                ...
                <form action="{{ route('slider.update', $slider->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="link" value="{{ $slider->link }}" placeholder="Enter slider link"
                            ...
                            <div class="">
                                ...
                                <div class="flex justify-center md:justify-start md:mr-4 md:mb-4" id="single-image-upload">
                                    <div id="drop-area-single"
                                        ...
                                        <img id="image-preview-single" src="{{ asset($slider->image) }}"
                        ...
                        <div>
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <span class="ml-3 text-sm font-medium text-gray-900 status-text">
                                    {{ old('status', $slider->status) == 'active' ? 'Active' : 'Inactive' }}
                                </span>
                            </label>
                        </div>
                    </div>
